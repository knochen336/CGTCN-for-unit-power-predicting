    ...
    for epoch in trange(EPOCH, desc="Epochs"):
        ...
        if epoch_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(),
                       f'./model_save/gtcn_best{BATCHSIZE}_{lEARINING_RATE}_{EPOCH}_24.pth')
        scheduler1.step()
        scheduler2.step()
    torch.save(model.state_dict(),
               f'./model_save/gtcn_last{BATCHSIZE}_{lEARINING_RATE}_{EPOCH}_24.pth')
...
plt.legend()
plt.show()
with open('gtcn_24.csv', 'w', newline='') as file:
