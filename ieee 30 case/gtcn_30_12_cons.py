...
from net.gtcn_12_cons import Net
...
pathstr = f'./model_save/gtcn_best32_0.0002_280_12.pth'  # 0.0999
    ...
    for epoch in trange(EPOCH, desc="Epochs"):
        ...
        if epoch_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(),
                       f'./model_save/gtcn_best{BATCHSIZE}_{lEARINING_RATE}_{EPOCH}_12_cons.pth')
        scheduler1.step()
        scheduler2.step()
    torch.save(model.state_dict(),
               f'./model_save/gtcn_last{BATCHSIZE}_{lEARINING_RATE}_{EPOCH}_12_cons.pth')
...
plt.legend()
plt.show()
with open('gtcn_12_cons.csv', 'w', newline='') as file:
