...
from net.GTCN_new_ontcn_6 import *
import pandas as pd
import numpy as np
    ...
    for epoch in trange(EPOCH, desc="Epochs"):
        ...
        if epoch_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(),
                       f'./model_save_118_new/model_best{BATCHSIZE}_{lEARINING_RATE}_{EPOCH}_length6.pth')
        scheduler1.step()
        scheduler2.step()
    torch.save(model.state_dict(),
               f'./model_save_118_new/model_last{BATCHSIZE}_{lEARINING_RATE}_{EPOCH}_length6.pth')
...
plt.legend()
plt.show()
with open('gtcn_new_12_losses_and_mse_smoothl1_batch16_6.csv', 'w', newline='') as file:
